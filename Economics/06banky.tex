...
\begin{itemize}[label=\textcolor{WPP}{$\hookrightarrow$}]
\item investiční služby \texthl{$\rightarrow$} podílové fondy, akcie, cenné papíry
\item pojišťovací služby \texthl{$\rightarrow$} životní, cestovní, neschopnost splácet, ke platebním kartám
\item pronájem bezpečnostních schránek
\end{itemize}
\end{wnumbered}
}
% 9-15
