...
\usepackage[left=1cm,right=1cm,top=1.5cm,bottom=1.5cm,showframe]{geometry} % To tell truth I do not know how it works with A4paper in documentclass but it works
...
Tohoto využije Claudius, který \texthl{Laerta poštve proti \textbf{Hamletovi}}.
