...
{\subsection*{{\color{antiDP}$\faGreaterThan$}\color{antiDP}#1}\nobreak}%
}
...
\pagestyle{empty}
\begin{document}\fontsize{10pt}{10pt}\selectfont\setlength{\parindent}{0em}\setlength{\parskip}{0em}
\vspace*{\fill}
\wbreak
...
\begin{center}
\begin{tikzpicture}
\node[minimum width=\textwidth-12em](vecbox){};
\node[align=center] at (vecbox.south) {Vytvořil \href{https://github.com/ScamanderWayne/}{\color{WPP}Libor Halík}.\\
Licencováno pod \href{https://creativecommons.org/licenses/by-nc-sa/4.0/deed.en}{\color{WPP}\ccbyncsaeu\-\ 4.0 International License}.
\vspace{3em}};
\node[anchor=south west] at (vecbox.south west) {\pgfornament[width=1cm,color=WPP]{28}};
\node[anchor=south east] at (vecbox.south east) {\pgfornament[width=1cm,color=WPP]{28}};
\end{tikzpicture}
\end{center}
\end{document}