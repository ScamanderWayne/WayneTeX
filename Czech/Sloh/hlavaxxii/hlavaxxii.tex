...
\begin{document}\fontsize{10pt}{10pt}\selectfont\setlength\parindent{0em}
	...
	Během \textbw{2.~světové~války} lítal s bombardérem v rámci amerického letectva.
	Po válce studoval na Kolumbijské univerzitě a později učil tvůrčí psaní.
	Hlava~XXII, vydaná v~roce 1961, mu přinesla světovou slávu, i když zpočátku nebyla komerčně úspěšná.
	Heller napsal i~další romány, například \wemph{Něco~se~stal}o nebo \wemph{Dobrý~jako~zlato}, ale žádný nedosáhl takového ohlasu jako jeho právě \wemph{Hlava~XXII}.
