...
{\HUGE\color{WPP}\textbf{Maturitní otázky \colorbox{WPP}{\color{DP}Literatura}}}\\
\vspace{0em}%
{\color{WPP}\pgfornament[width=\textwidth]{88}}%
\vspace{0em}\par
\begin{center}
{\large Seznam dvaceti knih z maturitní četby.}\par
...
Zpracovával jsem to v rámci \texthl{školního roku 2025/26}.

\bigskip
Pokud si všimnete jakékoli hrubky.
Ať už gramatické, či faktické, neváhejte se ozvat na mail \texthl{libor.halik.sw@gmail.com},
...
%\renewcommand\contentsname{{\color{WPP}Maturitní otázky{ }}\colorbox{WPP}{\color{DP}Literatura}}
